...
public class EditIncomeDialog extends JDialog {
    ...
    public EditIncomeDialog(java.awt.Frame parent, boolean modal, IncomePanel parentPanel, int incomeId) {
        super(parent, modal);
    ...
    private void initCurrentData() {
        try {
            Income currentIncome = incomeService.findById(this.incomeId);
            amountField.setText(String.valueOf(currentIncome.amount));
            descriptionField.setText(currentIncome.description);
            dateField.setText(DateConverter.toFormattedDate(currentIncome.date));
            categoryComboBox.getModel().setSelectedItem(currentIncome.incomeSource);
    ...
    private void saveButtonActionPerformed(ActionEvent evt) {
        try {
            if (amountField.getText().isEmpty()) {
                ...
                incomeService.update(new Income(incomeId,amount, description, date, pref.get("username", ""), incomeSource));
                JOptionPane.showMessageDialog(this, "Successfully update the income");
